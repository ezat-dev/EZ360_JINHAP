    ...
    public void doFilter(ServletRequest request, ServletResponse response,
      ...
      // System.out.println("필터 도착");
       ...
       // System.out.println("요청 uri: " + uri);
        ...
        if (uri.contains("/css") || uri.contains("/include") || uri.startsWith("/geomet/css/") || uri.equals("/geomet/") || uri.contains("/user/login/check") || uri.equals("/")) {
        ...
        if (!isLoggedIn) {
            ...
            out.println("<script>");
            out.println("alert('프로그램 재적용 완료. 다시 로그인 해주세요.');");
