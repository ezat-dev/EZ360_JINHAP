 ...
 * =============================== */
 ...
 function getDataList() {
     ...
     const columns = [
           ...
           { title: "No", formatter: "rownum", width: 50, hozAlign: "center", vertAlign: "middle", headerSort: false },
           { title: "년/월", field: "y_m", width: 120, hozAlign: "center", vertAlign: "middle", headerSort: false },

           { title: "명칭", field: "box1", width: 120, editor: "input", vertAlign: "middle", hozAlign: "center", headerSort: false },
           { title: "관리기준", field: "box2", width: 120, editor: "input", vertAlign: "middle", hozAlign: "center", headerSort: false },
           { title: "점검주기", field: "box3", width: 120, editor: "input", vertAlign: "middle", hozAlign: "center", headerSort: false },
           { title: "비고", field: "box4", width: 120, editor: "input", vertAlign: "middle", headerSort: false },
         {
             title: "이미지",
             width: 100,
             vertAlign: "middle",
...
$("#btnExcel").click(function (event) {
    ...
    const tempTable = new Tabulator(tempDiv, {
        ...
        columns: [
            ...
            { title: "명칭", field: "box1", width: 120 },
            { title: "관리기준", field: "box2", width: 220 },
            { title: "점검주기", field: "box3", width: 120 },
    ...
    setTimeout(() => {
        tempTable.download("xlsx", "스팀_" + y_m + ".xlsx", {
            sheetName: "스팀데이터"
        });
