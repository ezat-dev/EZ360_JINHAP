...
$(document).ready(function () {
    ...
    $(".select-button").click(function () {
        ...
        dataTable.setData("/geomet/user/standardDoc/list", {
            mch_name: mch_name,
            startDate: startDate,
            endDate: endDate
        });
    ...
    $("#saveCorrStatus").click(function (event) {
        ...
        $.ajax({
            url: "/geomet/user/standardDoc/insert",
            type: "POST",
            data: formData,
            dataType: "json",
            processData: false,
    ...
    $(".delete-button").click(function(event) {
        ...
        $.ajax({
            url: "/geomet/user/standardDoc/del",
            type: "POST",
...
function getDataList() {
    dataTable = new Tabulator("#dataList", {
        ...
        ajaxConfig: "POST",
        ajaxLoader: false,
        ajaxURL: "/geomet/user/standardDoc/list",
        ajaxParams: {
        ...
        columns: [
            ...
            { title: "설비", field: "mch_name", width: 120, hozAlign: "center" },
            {
                ...
                formatter: function(cell, formatterParams, onRendered) {
                    ...
                    if (!fileName) return "";
                    return '<a href="/geomet/download_standardDoc?filename=' +
