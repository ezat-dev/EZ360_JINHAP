    ...
    function initTables() {
    	...
    	table1 = new Tabulator("#table1", {
    	    ...
    	    columns: [
    	        ...
    	        { title: "점도</br>PLUS : 45±10초", field: "visc", headerSort: false },
    	        ...
    	        { title: "액온도</br>(38°C 이하)", field: "liq_temp", hozAlign: "center", headerSort: false },
    	        { title: "비중</br>1.43±0.05)", field: "sg", hozAlign: "center", headerSort: false }
    	    ],
    	...
    	table3 = new Tabulator("#table3", {
    	    ...
    	    columns: [
    	        { title: "순서", field: "r_num", hozAlign: "center",headerSort: false },
    	        ...
    	        { title: "품명", field: "item_nm", hozAlign: "center" ,headerSort: false},
    	        ...
    	        { title: "검사항목", columns: [
    	            ...
    	            { title: "밀착성 테스트", field: "c", hozAlign: "center" ,headerSort: false},
