        ...
        function getDataList() {
            dataTable = new Tabulator("#dataList", {
                ...
                columns: [
                    ...
                    {title: "품번", field: "2", sorter: "string", width: 350, hozAlign: "center", headerSort: false},
                    {title: "품명", field: "3", sorter: "string", width: 350, hozAlign: "center", headerSort: false},
                    {title: "긴급도", field: "4", sorter: "string", width: 350, hozAlign: "center", headerSort: false},
                    {title: "후처리 사양", field: "5", sorter: "string", width: 300, hozAlign: "center", headerSort: false},
