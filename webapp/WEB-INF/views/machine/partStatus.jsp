...
$(function() {
    ...
    dataTable = new Tabulator('#dataTable', {
        ...
        columns: [
            ...
            { title: "대상 설비", field: "equipment_name", hozAlign: "left", width: 180, headerFilter: "input" },
            { title: "부품명", field: "category_sub",  hozAlign: "left", width: 180, headerFilter: "input" },
            { title: "사용처", field: "category_mid",  hozAlign: "left", width: 200, headerFilter: "input" },
            { title: "규격", field: "part_name",     hozAlign: "left", width: 200, headerFilter: "input" },

            { title: "제작 업체", field: "manufacturer", hozAlign: "right", width: 130 , headerFilter: "input"},
    ...
    $('.select-button').click(function() {
        ...
        dataTable.setData("/geomet/machine/partStatus/list", { 
            mch_name: selMch,
            month: selMonth
        });
    });
