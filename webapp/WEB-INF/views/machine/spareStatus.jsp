  ...
  $(function() {
    dataTable = new Tabulator('#dataTable', {
      ...
      columns: [
        ...
        { title: "설비명",              field: "mch_name",       width: 150, hozAlign: "center" },
        { title: "부품명",               field: "mch_parts",    width: 140, hozAlign: "center" },
        { title: "사용처",               field: "a_usage",       width: 140, hozAlign: "center" },
        { title: "규격",    			field: "standard",         width: 140, hozAlign: "center" },
        { title: "제작업체",           field: "producer",  width: 150, hozAlign: "center" },
        { title: "교체<br>상기/정기",    field: "replacement",    width: 100, hozAlign: "center" },
        { title: "구매주기<br>월/반기/년", field: "buy_cycle",      width: 100, hozAlign: "center" },
        { title: "현재고",                field: "now_stock",   width: 100, hozAlign: "center" },
        { title: "안전재고",                field: "stock",   width: 100, hozAlign: "center" },
