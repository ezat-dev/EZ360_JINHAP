...
<body>
    ...
    <div class="modal-content">
      ...
      <form id="corrForm" autocomplete="off">
	    <!-- 고정값 -->
	    <input type="text" name="plac_cd" value="JH_KR_01" style="display:none;">
	    <input type="text" name="plnt_cd" value="02" style="display:none;">
	    ...
	    <label>시료수</label>
	    <input type="text" name="sample_f" placeholder="예: 5">
	
	    <label>표면적 (1EA)</label>
	    <input type="text" name="area_g" placeholder="예: 15.5">
...
$(document).ready(function () {
    ...
    $("#saveCorrStatus").click(function (event) {
        ...
        $.ajax({
            url: "/geomet/quality/test_info/insert",
            type: "POST",
            data: corrForm,
            dataType: "json",
            processData: false,
    ...
    $(".delete-button").click(function (event) {
        ...
        $.ajax({
            url: "/geomet/quality/test_info/del",
            type: "POST",
...
function initDataTable() {
    dataTable = new Tabulator("#dataList", {
        ...
        rowDblClick: function (e, row) {
            ...
            $f.find('input[name="sample_f"]').val(d.sample_f);
            $f.find('input[name="area_g"]').val(d.area_g);
            $f.find('input[name="total_area_h"]').val(d.total_area_h);
            $f.find('input[name="user_id"]').val(d.user_id);
            $f.find('input[name="upd_dt"]').val(d.upd_dt);
...
function loadData() {
    $.ajax({
        url: "/geomet/quality/test_info/list",
        type: "POST",
        dataType: "json",
        data: {
