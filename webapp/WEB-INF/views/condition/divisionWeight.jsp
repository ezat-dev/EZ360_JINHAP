...
function initDataTable() {
    dataTable = new Tabulator("#dataList", {
        ...
        columns: [
            ...
            { title: "품명", field: "item_nm", sorter: "string", width: 360, headerSort: false },
            { title: "메인설비", field: "mach_main", sorter: "string", width: 90, hozAlign: "center", headerSort: false },
            { title: "메인장입</br>기준", field: "mach_main_weight", sorter: "string", width: 100, hozAlign: "center", headerSort: false },
            { title: "표면처리 사양", field: "coating_nm", sorter: "string", width: 190,  headerSort: false },
            { title: "보조설비", field: "mach_sub", sorter: "string", width: 100, hozAlign: "center", headerSort: false },
            { title: "보조설비</br>기준", field: "mach_sub_weight", sorter: "string", width: 100, hozAlign: "center", headerSort: false },
            { title: "공용설비", field: "mlpl_weight", sorter: "string", width: 100, hozAlign: "center", headerSort: false },
            { title: "K-BLACK", field: "kblack_weight", sorter: "string", width: 100, hozAlign: "center", headerSort: false },
